              ...
              {/* Category */}
               ...
               <label className="block font-semibold mb-2">
                ...
                >
                 ...
                 <option value="Conditioning Gear">Conditioning Gear</option>
               ...
               <label className="block font-semibold mb-2">
                Equipment Type
                 ...
                 <input
                  type="text"
                  name="equipmentType"
                value={productData.equipmentType}
                placeholder="e.g. Dumbbell, Barbell, Kettlebell"
                onChange={handleChange}
                className="w-full border border-gray-300 rounded-md p-2"
                 />
            </div>
